        ...
        <div className="flex flex-col gap-5 flex-1 text-center lg:text-left">
          ...
          <div className="flex flex-col gap-4 text-[#d8d8d8] text-lg mx-auto lg:mx-0">
            <div className="flex items-center gap-3">
              <Image src="/mail_icon.svg" height={24} width={24} alt="Email" />
              <a href="mailto:nishantneupane488@gmail.com" className="hover:text-[#df8908] transition-colors">
                nishantneupane488@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Image src="/call_icon.svg" height={24} width={24} alt="Phone" />
              <a href="tel:+9779840033587" className="hover:text-[#df8908] transition-colors">
                +977 9840033587
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Image src="/location_icon.svg" height={24} width={24} alt="Location" />
              <p>Kathmandu, Nepal</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href="https://github.com/nishant-neupane" target="_blank" rel="noopener noreferrer" className="hover:text-[#df8908] transition-colors">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.linkedin.com/in/nishant-neupane" target="_blank" rel="noopener noreferrer" className="hover:text-[#df8908] transition-colors">
